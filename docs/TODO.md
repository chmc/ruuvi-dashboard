...
## Phase 1: Prettier + ESLint Ecosystem (Low Risk)
...
1. **Read this plan** - Understand the task requirements
2. **Implement changes** - Make the code/config changes
3. **Run tests** - Execute `pnpm test`
4. **Run lint** - Execute `pnpm lint`
5. **Manual verification** - If UI changes, verify in browser
6. **User verification** - Ask user to verify
7. **Commit** - Either user commits or ask Claude to commit
8. **Next task** - Move to the next task
